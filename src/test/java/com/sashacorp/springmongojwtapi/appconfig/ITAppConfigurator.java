...
public class ITAppConfigurator {
	...
	public void stage3_initEventTypesRepository_should_initEventTypeRepositoryAndReturnList() {
		...
		/*
		 * BEWARE! saveAll has side-effects, i.e. it sets the entities id, so defaultEventTypes.equals(savedDefaultEventTypeList)
		 * functions correctly without additional fiddling
		 */
