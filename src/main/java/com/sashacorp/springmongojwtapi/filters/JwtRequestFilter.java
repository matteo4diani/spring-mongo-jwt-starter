...
/**
 * Filters each request for a valid {@link UsernamePasswordAuthenticationToken} 
 * unless the '.permitAll()' cause is applied to the matchers in {@link WebSecurityConfig}
 * @author matteo
 *
 */
@Component
